...
export default class AddBtn extends Component {
    ...
    handleCancel = (e) =>{
        ...
        API.get(`/cancel-friend?userId=${this.props.userId}&friendId=${this.props.data.userId}`)
        .then(res => {
        ...
        if(this.props.data.state === "add"){
            return(
                <div className="row">
                    ...
                    <div className="col-sm-6 col-12 mt-1">
                        <button onClick={this.handleCancel} id={this.props.data.resId} className="btn btn-danger w-100 float-right">cancel</button>
                    </div>
                </div>
            )
        }else{
